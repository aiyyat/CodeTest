...
INSERT INTO user(login_name, pwd, enabled, role, email_id) VALUES ('publisher2', '$2a$10$MUahUza86ErCxtsgpmMBDeR5VtoGHioRdl03/jQmkM/sk6L.Eg28e', TRUE, 'PUBLISHER','achuth.i@gmail.com');
INSERT INTO user(login_name, pwd, enabled, role, email_id) VALUES ('user1', '$2a$10$WcgRF8VQ8DKt4h4Hz9pWv.6MXnIRmcPr0j9jqsseprsBwTD4w8WSm', TRUE, 'USER','achuth.i@gmail.com');
INSERT INTO user(login_name, pwd, enabled, role, email_id) VALUES ('user2', '$2a$10$Q5bxyPXhHXFc1fRUMCRWR.GbgsXx9aGZdoEoEAz2JFEfckdyUKfOi', TRUE, 'USER','achuth.i@gmail.com');
