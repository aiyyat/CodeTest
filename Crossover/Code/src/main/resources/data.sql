-- ~Achuth: modified
INSERT INTO user(login_name, pwd, enabled, role, email_id) VALUES ('publisher1', '$2a$10$RC1.YFSL8o2vCIg6kB3fjuBB639BdjY6AD8rIw9oyWJLws/1Q6Lku', TRUE, 'PUBLISHER','achuth.i@gmail.com');
INSERT INTO user(login_name, pwd, enabled, role, email_id) VALUES ('publisher2', '$2a$10$MUahUza86ErCxtsgpmMBDeR5VtoGHioRdl03/jQmkM/sk6L.Eg28e', TRUE, 'PUBLISHER','technicalyorker@gmail.com');
INSERT INTO user(login_name, pwd, enabled, role, email_id) VALUES ('user1', '$2a$10$WcgRF8VQ8DKt4h4Hz9pWv.6MXnIRmcPr0j9jqsseprsBwTD4w8WSm', TRUE, 'USER','technicalyorker.2@gmail.com');
INSERT INTO user(login_name, pwd, enabled, role, email_id) VALUES ('user2', '$2a$10$Q5bxyPXhHXFc1fRUMCRWR.GbgsXx9aGZdoEoEAz2JFEfckdyUKfOi', TRUE, 'USER','technicalyorker.3@gmail.com');
