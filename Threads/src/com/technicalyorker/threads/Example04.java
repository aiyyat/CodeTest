...
/**
 * 
 * ArrayList like a lot of Collection Classes is not Synchronized by Default.
 * This is one of the primary differences between ArrayList and a Vector. Thus
 * is expected to perform better than Vector. CopyOnWriteArrayList provides the
 * best of both worlds. More on it later.
 * 
